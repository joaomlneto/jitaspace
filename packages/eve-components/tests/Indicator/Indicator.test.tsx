...
// TotalUnreadMailsIndicator is a pure presentational component that stayed in
// @jitaspace/ui (it needs no hooks). CharacterOnlineIndicator moved here and
// reads useCharacterOnlineStatus, so it is required after the hooks mock below.
...
const { CharacterOnlineIndicator } =
...
const indicatorColor = (container: HTMLElement) =>
  container.querySelector(".mantine-Indicator-root")?.getAttribute("style") ??
  "";
