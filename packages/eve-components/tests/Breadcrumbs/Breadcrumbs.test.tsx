...
import { CategoryBreadcrumbs, GroupBreadcrumbs } from "@jitaspace/ui";
...
describe("TypeInventoryBreadcrumbs", () => {
  it("renders category/group names and omits the type by default", () => {
    ...
    expect(
      screen.queryByText("Resolved inventory_type"),
