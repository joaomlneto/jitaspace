...
import { PostCharactersCharacterIdMailLabelsBodyColor } from "@jitaspace/esi-client";
import { getRandomArrayEntry } from "@jitaspace/utils";

export function MailLabelColorSelect({ ...otherProps }: ColorInputProps) {
  const colors = Object.keys(PostCharactersCharacterIdMailLabelsBodyColor);
