...
import { AsteroidBeltName } from "../../Text/AsteroidBeltName";
import { BloodlineName } from "../../Text/BloodlineName";
import { CalendarEventOwnerName } from "../../Text/CalendarEventOwnerName";
import { CategoryName } from "../../Text/CategoryName";
import { CSPACostText } from "../../Text/CSPACostText";
import { DogmaAttributeName } from "../../Text/DogmaAttributeName";
import { DogmaEffectName } from "../../Text/DogmaEffectName";
import { EveMailSenderName } from "../../Text/EveMailSenderName";
import { GroupName } from "../../Text/GroupName";
import { ISKAmount } from "../../Text/ISKAmount";
import { LabelName } from "../../Text/LabelName";
import { MailingListName } from "../../Text/MailingListName";
import { MarketGroupName } from "../../Text/MarketGroupName";
import { MoonName } from "../../Text/MoonName";
import { PlanetName } from "../../Text/PlanetName";
import { Position3DText } from "../../Text/Position3DText";
import { RaceName } from "../../Text/RaceName";
import { StargateName } from "../../Text/StargateName";
import { StarName } from "../../Text/StarName";
...
describe("Name components rendering a plain string prop", () => {
  ...
  it.each<[string, ReactElement, string]>([
    ...
    ["StargateName", <StargateName name="Stargate (Perimeter)" />, "Stargate (Perimeter)"],
...
describe("Position3DText", () => {
  ...
  it("omits an absent x while still rendering y and z", () => {
    renderWithMantine(
      <Position3DText data-testid="pos" position={[undefined as never, 5, 9]} />,
    );
