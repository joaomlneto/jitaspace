...
describe("AllianceCard", () => {
  ...
  it("renders a header right section when provided", () => {
    ...
    mockUseEsiAllianceMemberCorporations.mockReturnValue({ data: { data: [] } });
...
describe("EveEntityCard", () => {
  it("delegates to AllianceCard for alliance entities", () => {
    mockUseEsiName.mockReturnValue({ name: "Some Alliance", category: "alliance" });
    mockUseEsiAllianceInformation.mockReturnValue({ data: { data: { ticker: "X" } } });
    mockUseEsiAllianceMemberCorporations.mockReturnValue({ data: { data: [] } });
  ...
  it("delegates to CharacterCard for character entities", () => {
    mockUseEsiName.mockReturnValue({ name: "Some Pilot", category: "character" });
    mockUseCharacter.mockReturnValue({ data: undefined });
