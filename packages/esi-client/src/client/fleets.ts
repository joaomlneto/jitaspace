...
export const getCharactersCharacterIdFleet = (
  ...
  return axios.get(`/characters/${characterId}/fleet/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetCharactersCharacterIdFleetKey = (
  characterId: number,
  params?: GetCharactersCharacterIdFleetParams,
) => [`/characters/${characterId}/fleet/`, ...(params ? [params] : [])];

export type GetCharactersCharacterIdFleetQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCharactersCharacterIdFleet>>
>;
export type GetCharactersCharacterIdFleetQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetCharactersCharacterIdFleet = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getGetCharactersCharacterIdFleetKey(characterId, params)
        : null);
  const swrFn = () =>
    getCharactersCharacterIdFleet(characterId, params, axiosOptions);
...
export const getFleetsFleetId = (
  ...
  return axios.get(`/fleets/${fleetId}/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetFleetsFleetIdKey = (
  fleetId: number,
  params?: GetFleetsFleetIdParams,
) => [`/fleets/${fleetId}/`, ...(params ? [params] : [])];

export type GetFleetsFleetIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFleetsFleetId>>
>;
export type GetFleetsFleetIdQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetFleetsFleetId = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetFleetsFleetIdKey(fleetId, params) : null));
...
export const putFleetsFleetId = (
  ...
  return axios.put(`/fleets/${fleetId}/`, putFleetsFleetIdBody, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const getFleetsFleetIdMembers = (
  ...
  return axios.get(`/fleets/${fleetId}/members/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetFleetsFleetIdMembersKey = (
  fleetId: number,
  params?: GetFleetsFleetIdMembersParams,
) => [`/fleets/${fleetId}/members/`, ...(params ? [params] : [])];

export type GetFleetsFleetIdMembersQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFleetsFleetIdMembers>>
>;
export type GetFleetsFleetIdMembersQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetFleetsFleetIdMembers = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetFleetsFleetIdMembersKey(fleetId, params) : null));
...
export const deleteFleetsFleetIdMembersMemberId = (
  ...
  return axios.delete(`/fleets/${fleetId}/members/${memberId}/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const deleteFleetsFleetIdSquadsSquadId = (
  ...
  return axios.delete(`/fleets/${fleetId}/squads/${squadId}/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const getFleetsFleetIdWings = (
  ...
  return axios.get(`/fleets/${fleetId}/wings/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetFleetsFleetIdWingsKey = (
  fleetId: number,
  params?: GetFleetsFleetIdWingsParams,
) => [`/fleets/${fleetId}/wings/`, ...(params ? [params] : [])];

export type GetFleetsFleetIdWingsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFleetsFleetIdWings>>
>;
export type GetFleetsFleetIdWingsQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetFleetsFleetIdWings = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetFleetsFleetIdWingsKey(fleetId, params) : null));
...
export const postFleetsFleetIdWings = (
  ...
  return axios.post(`/fleets/${fleetId}/wings/`, undefined, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const deleteFleetsFleetIdWingsWingId = (
  ...
  return axios.delete(`/fleets/${fleetId}/wings/${wingId}/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const postFleetsFleetIdWingsWingIdSquads = (
  ...
  return axios.post(`/fleets/${fleetId}/wings/${wingId}/squads/`, undefined, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
