...
export const getCharactersCharacterIdAssets = (
  ...
  return axios.get(`/characters/${characterId}/assets/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetCharactersCharacterIdAssetsKey = (
  characterId: number,
  params?: GetCharactersCharacterIdAssetsParams,
) => [`/characters/${characterId}/assets/`, ...(params ? [params] : [])];

export type GetCharactersCharacterIdAssetsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCharactersCharacterIdAssets>>
>;
export type GetCharactersCharacterIdAssetsQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetCharactersCharacterIdAssets = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getGetCharactersCharacterIdAssetsKey(characterId, params)
        : null);
  const swrFn = () =>
    getCharactersCharacterIdAssets(characterId, params, axiosOptions);
...
export const postCharactersCharacterIdAssetsLocations = (
  ...
  AxiosResponse<PostCharactersCharacterIdAssetsLocations200Item[]>
> => {
  return axios.post(
...
export const getCorporationsCorporationIdAssets = (
  ...
  return axios.get(`/corporations/${corporationId}/assets/`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetCorporationsCorporationIdAssetsKey = (
  corporationId: number,
  params?: GetCorporationsCorporationIdAssetsParams,
) => [`/corporations/${corporationId}/assets/`, ...(params ? [params] : [])];

export type GetCorporationsCorporationIdAssetsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCorporationsCorporationIdAssets>>
>;
export type GetCorporationsCorporationIdAssetsQueryError = AxiosError<
  | void
  | BadRequest
  | Unauthorized
  | Forbidden
...
export const useGetCorporationsCorporationIdAssets = <
  TError = AxiosError<
    | void
    | BadRequest
    | Unauthorized
...
>(
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getGetCorporationsCorporationIdAssetsKey(corporationId, params)
        : null);
  const swrFn = () =>
    getCorporationsCorporationIdAssets(corporationId, params, axiosOptions);
...
export const postCorporationsCorporationIdAssetsLocations = (
  ...
  AxiosResponse<PostCorporationsCorporationIdAssetsLocations200Item[]>
> => {
  return axios.post(
...
export const postCorporationsCorporationIdAssetsNames = (
  ...
  AxiosResponse<PostCorporationsCorporationIdAssetsNames200Item[]>
> => {
  return axios.post(
