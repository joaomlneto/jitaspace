...
export const postUiAutopilotWaypoint = (
    params: PostUiAutopilotWaypointParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<void>> => {
    return axios.post(
      `/ui/autopilot/waypoint/`,undefined,{
    ...options,
...
export const postUiOpenwindowContract = (
    params: PostUiOpenwindowContractParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<void>> => {
    return axios.post(
      `/ui/openwindow/contract/`,undefined,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const postUiOpenwindowInformation = (
    params: PostUiOpenwindowInformationParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<void>> => {
    return axios.post(
      `/ui/openwindow/information/`,undefined,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const postUiOpenwindowMarketdetails = (
    params: PostUiOpenwindowMarketdetailsParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<void>> => {
    return axios.post(
      `/ui/openwindow/marketdetails/`,undefined,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const postUiOpenwindowNewmail = (
    ...
    params?: PostUiOpenwindowNewmailParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<void>> => {
    return axios.post(
