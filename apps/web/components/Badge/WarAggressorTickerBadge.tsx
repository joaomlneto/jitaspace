...
export const WarAggressorTickerBadge = memo(({ warId, ...otherProps }: WarAggressorTickerBadgeProps) => {
  ...
  if (aggressorAllianceId) {
    return <AllianceTickerBadge allianceId={aggressorAllianceId} {...otherProps} />;
  }
  return <CorporationTickerBadge corporationId={aggressorCorporationId} {...otherProps} />;
});
