...
export const SolarSystemStarAvatar = memo(({ solarSystemId, ...otherProps }: SolarSystemStarAvatarProps) => {
  ...
  return <UISolarSystemStarAvatar typeId={star?.data.type_id} {...otherProps} />;
});
