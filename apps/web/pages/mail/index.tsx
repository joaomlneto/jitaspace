              ...
              <Accordion.Panel>
                <Stack>
                  <Text>
                    ...
                    weekend project to learn a bit more about Next.js and React.
                    It is not perfect, but it works. Let me know if something is
                    broken!
                  </Text>
              ...
              <Accordion.Panel>
                <Stack>
                  ...
                  <Text>
                    ...
                    token, nor does it use it in any way other than to decrypt
            ...
            <Accordion.Item value="legal">
              ...
              <Accordion.Panel>
                <Text>
                  ...
                  Online, the EVE logo, EVE and all associated logos and designs
                  are the intellectual property of CCP hf. All artwork,
                  screenshots, characters, vehicles, storylines, world facts or
                  other recognizable features of the intellectual property
                  relating to these trademarks are likewise the intellectual
                  property of CCP hf. CCP hf. has granted permission to
                  JitaSpace to use EVE Online and all associated logos and
                  designs for promotional and information purposes on its
                  website but does not endorse, and is not in any way affiliated
                  with, JitaSpace. CCP is in no way responsible for the content
                  on or functioning of this website, nor can it be liable for
