...
const config: Config = {
  ...
  // cacheDirectory: "/private/var/folders/h5/t1749p1132d_mkqhxf5b_g000000gn/T/jest_dx",
  ...
  // A map from regular expressions to module names or to arrays of module names that allow to stub out resources with a
  // single module
  moduleNameMapper: {
    "^~/(.*)$": "<rootDir>/$1",
    ...
    "^@jitaspace/eve-components$":
      "<rootDir>/__mocks__/@jitaspace/eve-components.tsx",
