 ...
 * `TypeName` looks its own up in the database. The `*Anchor` components link
 * each resolved name to that entity's detail page (`/type/…`,
...
export function TypeName({
  ...
  const q = useQuery({
    ...sdeRecordQueryOptions("type", typeId),
    enabled: !name && !!typeId,
  });
  const label =
